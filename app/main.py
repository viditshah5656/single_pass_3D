...
def create_app() -> FastAPI:
    app = FastAPI(title="AeroSynth 3D Reconstruction API", description="Single-pass aerial photogrammetry and metrology engine", version="5.0.0")
...
def run_server(host: str, port: int, reload: bool = False) -> None:
    ...
    uvicorn.run("app.main:app" if reload else app, host=host, port=port, reload=reload,
